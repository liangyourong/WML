...
function drawCalendar(solarYear,solarMonth){
  ...
  for(var i=0;i<42;i++){
    ...
    if(i<=offset1){
      ...
      //work3
      holiday=holidayHTML(holidayCld.lastLHoliday,holidayCld.lastTermHoliday,holidayCld.lastSolarHoliday,holidayCld.lastYueZhouHoliday,day1-1);
        if(holiday!==undefined)
          DateItem.innerHTML  +=  "<br/><span class='holiday'>"+holiday+"</span>";
        else
      //work2
      ...
      //work3
      holiday=holidayHTML(holidayCld.nextLHoliday,holidayCld.nextTermHoliday,holidayCld.nextSolarHoliday,holidayCld.nextYueZhouHoliday,day2-1);
        if(holiday!==undefined)
          DateItem.innerHTML  +=  "<br/><span class='holiday'>"+holiday+"</span>";
        else{
          //work2
      ...
      DateItem.innerHTML+=day3;
       ...
       //work3
      holiday=holidayHTML(holidayCld.thisLHoliday,holidayCld.thisTermHoliday,holidayCld.thisSolarHoliday,holidayCld.thisYueZhouHoliday,day3-1);
        if(holiday!==undefined)
          DateItem.innerHTML  +=  "<br/><span class='holiday'>"+holiday+"</span>";
        else{
          //work2
